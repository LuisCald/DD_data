...
#
# USAGE
#   julia --project=. coefficients_to_micro_data.jl
...
#
# Only deps: CSV, DataFrames (wraps the canonical helper julia/reconstruct.jl).
...
function main()
    ...
    dest = joinpath(REPO, "data", "$(dataset)_synthetic_microdata.csv")
    CSV.write(dest, out)
